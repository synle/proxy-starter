...
curl -fsSL "https://github.com/synle/proxy-starter/blob/head/new-proxy.js?raw=1" | node - PORT=3000 TARGET_URL=http://example.com
```

#### For Windows
```bash
curl -fsSL "https://github.com/synle/proxy-starter/blob/head/new-proxy.js?raw=1" --output new-proxy.js
